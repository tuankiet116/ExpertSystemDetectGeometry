...
#tính góc giữa 2 tọa độ so với trục x
...
###############################################
# trả về danh sách chuỗi các facr
###############################################
class Fact:
...
#Kiểm tra các góc và đường thẳng => kiểm tra các điều kiện và sinh ra các kết quả tương ứng
